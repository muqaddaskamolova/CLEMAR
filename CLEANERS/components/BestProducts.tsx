        ...
        <div className="BestProducts parent py-8">
            <div className="wrapper mx-auto px-4 flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    ...
                    <a className="text-[#522480]  hover:underline" href="/best-products">View all</a>
                </div>
                <Swiper
                    modules={[Navigation]}
                    spaceBetween={30}
                ...
                >
                    {bestProducts.map((product) => (
                        <SwiperSlide key={product.id}>
                            <a className="product flex flex-col gap-1 p-4 rounded-lg bg-white shadow-md border border-[#522480]  transition-transform duration-200 hover:scale-105" href={`/products/${product.id}`}>
                                ...
                                <div className="flex justify-between items-center mt-2">
                                    ...
                                    <button className="bg-[#522480]  text-white px-4 py-1 rounded hover:bg-[#7024bc]  transition">
                                        Buy
                                    </button>
                                </div>
                            </a>
