        ...
        <div className="HomeCategories parent py-8">
            <div className="wrapper mx-auto px-4 flex flex-col gap-4">
                <div className="flex justify-between items-center">
                    ...
                    <a className="text-blue-500 hover:underline" href="/categories">View all</a>
                </div>
                <Swiper
                    modules={[Navigation]}
                    spaceBetween={30}
                ...
                >
                    {categories.map((category) => (
                        <SwiperSlide key={category.id}>
                            <a className="product flex flex-col justify-between gap-1 p-4 rounded-lg bg-white shadow-md border border-sky-400 transition-transform duration-200 hover:scale-105" href={`/categories/${category.id}`}>
