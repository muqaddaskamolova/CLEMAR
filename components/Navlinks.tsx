  ...
  return (
    <div className="flex items-center justify-between p-4 flex-wrap">
      ...
      <nav className="relative ml-6 mr-4">
        ...
        <div
          className={`absolute top-16 left-0 w-full bg-sky-400 dark:bg-gray-800 md:static md:bg-transparent md:flex md:items-center md:justify-start transition-all duration-300 ${isOpen ? 'block' : 'hidden'}`}
          id="navbar-hamburger"
        >
          <ul className="flex flex-col md:flex-row md:space-x-6 font-medium mt-2 dark:border-gray-700 w-full bg-sky-400 rounded-md p-2 justify-start">
            <li className="relative h-full mb-2 flex items-center">
              ...
              {dropdownOpen && (
                <div className="absolute left-0 mt-2 w-56 bg-sky-400 shadow-lg rounded-md z-10">
                  <ul className="flex flex-col w-full">
                    <li className="mb-2">
                      <Link href="/" className="block px-4 py-2 text-white hover:bg-sky-500">Home</Link>
                    </li>
                    <li className="mb-2">
      ...
      <div className="flex items-center space-x-4 ml-2">
        <Image
          src="/assets/images/clemar logo.png"
      ...
      <div className="relative h-12 w-96 flex-grow">
        ...
        <button
          ...
          className="absolute right-0 top-0 h-full w-20 bg-sky-400 rounded-r-md border-none cursor-pointer flex items-center justify-center"
          aria-label="Search"
        >
      ...
      <div className="flex items-center space-x-4 h-12 ml-4">
        <Link href="/news" className="text-gray-900 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white h-full flex items-center">About Us</Link>
